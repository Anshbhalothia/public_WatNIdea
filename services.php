        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                ...
                <div class="page-header-box">
                    <h1 class="text-anime-style-2" data-cursor="-opaque">WatNidea <span>services</span></h1>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                ...
                <div class="service-item wow fadeInUp">
                    ...
                    <div class="service-item-content">
                        <h3>Starter plan</h3>
                        <p>12–15 reels per month, basic editing, and caption support for a strong social presence.</p>
                        <a href="<?php echo BASE_URL; ?>/index.php?page=contact" class="readmore-btn">read more</a>
                    </div>
                </div>
                <!-- Service Item End -->
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="service-item-content">
                        <h3>Growth plan</h3>
                        <p>25–30 reels, carousel posts, complete content strategy, and weekly performance tracking.</p>
                        <a href="<?php echo BASE_URL; ?>/index.php?page=contact" class="readmore-btn">read more</a>
                    </div>
                </div>
                <!-- Service Item End -->
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="service-item wow fadeInUp" data-wow-delay="0.4s">
                    ...
                    <div class="service-item-content">
                        <h3>Domination plan</h3>
                        <p>High-volume content, DM funnel setup, trend research, and market-dominating brand growth.</p>
                        <a href="<?php echo BASE_URL; ?>/index.php?page=contact" class="readmore-btn">read more</a>
                    </div>
                </div>
                <!-- Service Item End -->
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="service-item wow fadeInUp" data-wow-delay="0.6s">
                    ...
                    <div class="service-item-content">
                        ...
                        <p>Audience research, hooks, scripting, captions, and posting systems built to support growth.</p>
                        <a href="<?php echo BASE_URL; ?>/index.php?page=contact" class="readmore-btn">read more</a>
                    </div>
                </div>
                <!-- Service Item End -->
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="service-item wow fadeInUp" data-wow-delay="0.8s">
                    ...
                    <div class="service-item-content">
                        <h3>Video editing</h3>
                        <p>Hook-first, high-quality edits for reels, ads, and long-form marketing content.</p>
                        <a href="<?php echo BASE_URL; ?>/index.php?page=contact" class="readmore-btn">read more</a>
                    </div>
                </div>
                <!-- Service Item End -->
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="service-item wow fadeInUp" data-wow-delay="1s">
                    ...
                    <div class="service-item-content">
                        ...
                        <p>Paid growth, funnel setup, and conversion-focused support to turn attention into enquiries.</p>
                        <a href="<?php echo BASE_URL; ?>/index.php?page=contact" class="readmore-btn">read more</a>
                    </div>
                </div>
                <!-- Service Item End -->
