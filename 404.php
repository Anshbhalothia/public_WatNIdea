        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="error-page-image wow fadeInUp">
                    <img src="<?php echo BASE_URL; ?>/assets/images/404-error-img.png" alt="">
                </div>
                <div class="error-page-content">
                    ...
                    <div class="error-page-content-body">
                        ...
                        <a class="btn-default wow fadeInUp" data-wow-delay="0.75s" href="<?php echo BASE_URL; ?>/index.php?page=home">back to home</a>
                    </div>
                </div>
            </div>
        </div>
