        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                ...
                <div class="page-header-box">
                    <h1 class="text-anime-style-2" data-cursor="-opaque">About <span>WatNidea</span></h1>
                ...
                <div class="about-us-box">
                    ...
                    <div class="about-us-content">
                        ...
                        <div class="about-us-body wow fadeInUp" data-wow-delay="0.2s">
                            <p>WatNidea builds digital-first growth systems for brands that want stronger visibility, better content, and more qualified leads.</p>
                        </div>
                        <!-- About Us Body End -->
                ...
                <div class="our-approach-content">
                    ...
                    <div class="our-approach-box">
                        ...
                        <div class="our-approach-item wow fadeInUp" data-wow-delay="0.4s">
                            <div class="icon-box">
                                <img src="<?php echo BASE_URL; ?>/assets/images/icon-mission.svg" alt="">
                            </div>
                        ...
                        <div class="our-approach-item wow fadeInUp" data-wow-delay="0.6s">
                            <div class="icon-box">
                                <img src="<?php echo BASE_URL; ?>/assets/images/icon-vision.svg" alt="">
                            </div>
                            <div class="approach-item-content">
                                <h3>Our vision</h3>
                ...
                <div class="our-approach-images">
                    ...
                    <div class="approach-image-box-1">
                        <div class="our-approach-img">
                            <figure class="image-anime reveal">
                                <img src="<?php echo BASE_URL; ?>/assets/images/approach-img-1.jpg" alt="">
                            </figure>
                        </div>

                        <div class="our-approach-img">
                            <figure class="image-anime reveal">
                                <img src="<?php echo BASE_URL; ?>/assets/images/approach-img-2.jpg" alt="">
                            </figure>
                        </div>
                    </div>
                    ...
                    <div class="approach-image-box-2">
                        <div class="our-approach-img">
                            <figure class="image-anime reveal">
                                <img src="<?php echo BASE_URL; ?>/assets/images/approach-img-3.jpg" alt="">
                            </figure>
                        </div>
                    </div>
                    <!-- Approach Image Box End -->
                    ...
                    <div class="approach-image-circle">
                        <img src="<?php echo BASE_URL; ?>/assets/images/approach-image-circle.png" alt="">
                    </div>
                ...
                <div class="what-we-do-content">
                    ...
                    <div class="what-we-body">
                        ...
                        <div class="what-we-btn wow fadeInUp" data-wow-delay="0.2s">
                            <a href="<?php echo BASE_URL; ?>/index.php?page=contact" class="btn-default"><span>get started</span></a>
                        </div>
                        <!-- What We Button End -->
                    </div>
                    <!-- What We Body End -->
                    ...
                    <div class="what-we-social-box">
                        ...
                        <div class="what-we-social-image">
                            <figure class="image-anime reveal">
                                <img src="<?php echo BASE_URL; ?>/assets/images/what-we-social-image.jpg" alt="">
                            </figure>
                        </div>
                        ...
                        <div class="what-we-social-content wow fadeInUp" data-wow-delay="0.2s">
                            <p>Empowering brands to unlock measurable growth through strategy-led content, funnels, and performance marketing.</p>
            ...
            <div class="col-lg-6">
                ...
                <div class="what-we-images">
                    <div class="what-we-img">
                        <figure class="image-anime reveal">
                            <img src="<?php echo BASE_URL; ?>/assets/images/what-we-img.jpg" alt="">
                        </figure>
                    </div>
                    <div class="our-agency-circle">
                        <a href="<?php echo BASE_URL; ?>/index.php?page=contact"><img src="<?php echo BASE_URL; ?>/assets/images/our-agency-circle.png" alt=""></a>
                    </div>
                </div>
                <!-- What We Images End -->
            </div>
    ...
    <div class="container">
        <div class="row section-row align-items-center">
            ...
            <div class="col-lg-4">
                <!-- Section Button Start -->
                <div class="section-btn wow fadeInUp" data-wow-delay="0.2s">
                    <a href="<?php echo BASE_URL; ?>/index.php?page=contact" class="btn-default">all team members</a>
                </div>
                <!-- Section Button End -->
            </div>
        </div>
                ...
                <div class="our-soultion-content">
                    ...
                    <div class="our-soultion-box">
                        ...
                        <div class="our-soultion-item">
                            <div class="icon-box">
                                <img src="<?php echo BASE_URL; ?>/assets/images/icon-facebook.svg" alt="">
                            </div>
                        ...
                        <div class="our-soultion-item">
                            <div class="icon-box">
                                <img src="<?php echo BASE_URL; ?>/assets/images/icon-Linkedin.svg" alt="">
                            </div>
                            <div class="soultion-item-content">
                        ...
                        <div class="our-soultion-item">
                            <div class="icon-box">
                                <img src="<?php echo BASE_URL; ?>/assets/images/icon-instagram.svg" alt="">
                            </div>
                            <div class="soultion-item-content">
                        ...
                        <div class="our-soultion-item">
                            <div class="icon-box">
                                <img src="<?php echo BASE_URL; ?>/assets/images/icon-tiktok.svg" alt="">
                            </div>
                            <div class="soultion-item-content">
                        ...
                        <div class="our-soultion-item">
                            <div class="icon-box">
                                <img src="<?php echo BASE_URL; ?>/assets/images/icon-youtube.svg" alt="">
                            </div>
                            <div class="soultion-item-content">
                        ...
                        <div class="our-soultion-item">
                            <div class="icon-box">
                                <img src="<?php echo BASE_URL; ?>/assets/images/icon-twitter.svg" alt="">
                            </div>
                            <div class="soultion-item-content">
            ...
            <div class="col-lg-6">
                ...
                <div class="soultion-image-box">
                    ...
                    <div class="our-soultion-image">
                        <figure class="image-anime reveal">
                            <img src="<?php echo BASE_URL; ?>/assets/images/our-soultion-image.jpg" alt="">
                        </figure>
                    </div>
